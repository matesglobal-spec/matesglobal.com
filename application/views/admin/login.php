...
<head>
  ...
  <title>Mates Group Admin | Log in</title>
...
<div class="login-box">
 <center>
  ...
  <div class="login-logo" style="background:#2a92c3">
    <a style="color:#fff"><b>Mates</b>Group</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="background:linear-gradient(#2090bb, #36d1ff00)">
